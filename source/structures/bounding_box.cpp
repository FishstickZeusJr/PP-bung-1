...
{
    double width = (x_max - x_min) / 2;
    double height = (y_max - y_min) / 2;

    switch (index) {
    case 0: return BoundingBox(x_min, x_min + width, y_min, y_min + height);
    case 1: return BoundingBox(x_min + width, x_max, y_min, y_min + height);
    case 2: return BoundingBox(x_min, x_min + width, y_min + height, y_max);
    case 3: return BoundingBox(x_min + width, x_max, y_min + height, y_max);
